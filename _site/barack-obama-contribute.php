...
<body class="interior obama-contribute sequential">
		...
		<div class="container">
			<div class="row">
				...
				<div class="sevencol last sequential">
					<img src="img/interior_contribute_header_module.png" alt="Contribute.BarackObama.com">
				</div>
			</div><!-- END row -->
		</div>
	</div>
	...
	<section class="module road-to-sequential">
		...
		<div class="container">
			<div class="row">
				<div class="sevencol">
					<img src="img/interior_contribute-road-to-sequential.png" alt="Road To Sequential">
				</div> <!-- /sevencol -->
	...
	<section class="module blue revamp">
		...
		<div class="inner-container">
			...
			<img src="img/interior_contribute_stage_2.jpg" alt="Stage 2">
		</div> <!-- /container row -->
	</section><!-- /module blue -->
		...
		<div class="container row">
			<div class="inner-container">
				...
				<div class="image-container">
					<img src="img/interior_contribute_wireframe.jpg" alt="Contribute Wireframes">
				</div> <!-- /image-container -->
		...
		<div id="donate-form-mobile">
			...
			<div id="slider">
				<div class="flexslider">
				    <ul class="slides">
				    	<li>
				    		<img src="img/contribute_slides_1.jpg">
				    	</li>
				    	<li>
				    		<img src="img/contribute_slides_2.jpg">
				    	</li>
				    	<li>
				    		<img src="img/contribute_slides_3.jpg">
				    	</li>
				    	<li>
				    		<img src="img/contribute_slides_4.jpg">
				    	</li>
				    </ul>
			    </div>
			</div>
