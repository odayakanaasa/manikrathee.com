...
;var LastFMStatus = {
  ...
  updateView: function() {
    ...
    if (this.trackInfo.error) {
      ...
      message  = '<i class="icon icon--spotify-circle"></i><p>Listening to: <span>' + this.trackInfo.artist + ' - ' + this.trackInfo.song + '</span></p>';
    }
...
})(jQuery, window, document);;var $body = $('body');
