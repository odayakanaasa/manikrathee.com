...
var LastFMStatus = {
    ...
    updateView: function() {
        ...
        b = '<a href="http://www.manikrathee.com/spotify/" class="spotify-link no-border" title="@ManikRathee is listening to "' + this.trackInfo.artist + ' on Spotify" itemprop="url">Listening to: <span>' + this.trackInfo.artist + " - " + this.trackInfo.song + "</span></div></a>"), 
