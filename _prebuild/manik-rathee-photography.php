					...
					<div class="tencol no_pad">
							<div id="slider" class="mrphoto_slides">
								<div class="flexslider">
								    <ul class="slides">
								    	<li>
								    		<img src="img/mrphoto_slides_1.jpg">
								    	</li>
								    	<li>
								    		<img src="img/mrphoto_slides_2.jpg">
								    	</li>
								    	<li>
								    		<img src="img/mrphoto_slides_3.jpg">
								    	</li>
								    	<li>
								    		<img src="img/mrphoto_slides_4.jpg">
								    	</li>
								    	<li>
								    		<img src="img/mrphoto_slides_5.jpg">
								    	</li>
